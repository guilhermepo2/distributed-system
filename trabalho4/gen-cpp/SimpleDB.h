...
typedef struct _SimpleDB_add_tw_args__isset {
  _SimpleDB_add_tw_args__isset() : url(false), content(false) {}
  bool url :1;
  bool content :1;
} _SimpleDB_add_tw_args__isset;

class SimpleDB_add_tw_args {
 public:

  SimpleDB_add_tw_args(const SimpleDB_add_tw_args&);
  SimpleDB_add_tw_args& operator=(const SimpleDB_add_tw_args&);
  SimpleDB_add_tw_args() : url(), content() {
  }

  virtual ~SimpleDB_add_tw_args() throw();
  std::string url;
  std::string content;

  _SimpleDB_add_tw_args__isset __isset;

  void __set_url(const std::string& val);

  void __set_content(const std::string& val);

  bool operator == (const SimpleDB_add_tw_args & rhs) const
  {
    if (!(url == rhs.url))
      return false;
    if (!(content == rhs.content))
  ...
  bool operator < (const SimpleDB_add_tw_args & ) const;
...
class SimpleDB_add_tw_pargs {
 public:


  virtual ~SimpleDB_add_tw_pargs() throw();
  const std::string* url;
  const std::string* content;
...
typedef struct _SimpleDB_add_tw_result__isset {
  _SimpleDB_add_tw_result__isset() : success(false) {}
  bool success :1;
} _SimpleDB_add_tw_result__isset;

class SimpleDB_add_tw_result {
 public:

  SimpleDB_add_tw_result(const SimpleDB_add_tw_result&);
  SimpleDB_add_tw_result& operator=(const SimpleDB_add_tw_result&);
  SimpleDB_add_tw_result() : success(0) {
  }

  virtual ~SimpleDB_add_tw_result() throw();
  version_t success;

  _SimpleDB_add_tw_result__isset __isset;

  void __set_success(const version_t val);

  bool operator == (const SimpleDB_add_tw_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const SimpleDB_add_tw_result & ) const;
...
typedef struct _SimpleDB_add_tw_presult__isset {
  _SimpleDB_add_tw_presult__isset() : success(false) {}
  bool success :1;
} _SimpleDB_add_tw_presult__isset;

class SimpleDB_add_tw_presult {
 public:


  virtual ~SimpleDB_add_tw_presult() throw();
  version_t* success;

  _SimpleDB_add_tw_presult__isset __isset;
...
typedef struct _SimpleDB_get_response_args__isset {
  ...
  bool msg :1;
} _SimpleDB_get_response_args__isset;

class SimpleDB_get_response_args {
 public:

  SimpleDB_get_response_args(const SimpleDB_get_response_args&);
  SimpleDB_get_response_args& operator=(const SimpleDB_get_response_args&);
  SimpleDB_get_response_args() : msg() {
  }

  virtual ~SimpleDB_get_response_args() throw();
  std::string msg;

  _SimpleDB_get_response_args__isset __isset;

  void __set_msg(const std::string& val);

  bool operator == (const SimpleDB_get_response_args & rhs) const
  {
    if (!(msg == rhs.msg))
      return false;
    return true;
  ...
  bool operator < (const SimpleDB_get_response_args & ) const;
...
class SimpleDB_get_response_pargs {
 public:


  virtual ~SimpleDB_get_response_pargs() throw();
...
typedef struct _SimpleDB_get_response_result__isset {
  _SimpleDB_get_response_result__isset() : success(false) {}
  bool success :1;
} _SimpleDB_get_response_result__isset;

class SimpleDB_get_response_result {
 public:

  SimpleDB_get_response_result(const SimpleDB_get_response_result&);
  SimpleDB_get_response_result& operator=(const SimpleDB_get_response_result&);
  SimpleDB_get_response_result() : success(0) {
  }

  virtual ~SimpleDB_get_response_result() throw();
  bool success;

  _SimpleDB_get_response_result__isset __isset;

  void __set_success(const bool val);

  bool operator == (const SimpleDB_get_response_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const SimpleDB_get_response_result & ) const;
...
typedef struct _SimpleDB_get_response_presult__isset {
  _SimpleDB_get_response_presult__isset() : success(false) {}
  bool success :1;
} _SimpleDB_get_response_presult__isset;

class SimpleDB_get_response_presult {
 public:


  virtual ~SimpleDB_get_response_presult() throw();
  bool* success;

  _SimpleDB_get_response_presult__isset __isset;

  uint32_t read(::apache::thrift::protocol::TProtocol* iprot);

};

typedef struct _SimpleDB_tw_feedback_args__isset {
  _SimpleDB_tw_feedback_args__isset() : msg(false) {}
  bool msg :1;
} _SimpleDB_tw_feedback_args__isset;

class SimpleDB_tw_feedback_args {
 public:

  SimpleDB_tw_feedback_args(const SimpleDB_tw_feedback_args&);
  SimpleDB_tw_feedback_args& operator=(const SimpleDB_tw_feedback_args&);
  SimpleDB_tw_feedback_args() : msg() {
  }

  virtual ~SimpleDB_tw_feedback_args() throw();
  std::string msg;

  _SimpleDB_tw_feedback_args__isset __isset;

  void __set_msg(const std::string& val);

  bool operator == (const SimpleDB_tw_feedback_args & rhs) const
  {
    if (!(msg == rhs.msg))
      return false;
    return true;
  ...
  bool operator < (const SimpleDB_tw_feedback_args & ) const;
...
class SimpleDB_tw_feedback_pargs {
 public:


  virtual ~SimpleDB_tw_feedback_pargs() throw();
  const std::string* msg;
...
class SimpleDB_tw_feedback_result {
 public:

  SimpleDB_tw_feedback_result(const SimpleDB_tw_feedback_result&);
  SimpleDB_tw_feedback_result& operator=(const SimpleDB_tw_feedback_result&);
  SimpleDB_tw_feedback_result() {
  }

  virtual ~SimpleDB_tw_feedback_result() throw();

  bool operator == (const SimpleDB_tw_feedback_result & /* rhs */) const
  {
    return true;
  }
  bool operator != (const SimpleDB_tw_feedback_result &rhs) const {
  ...
  bool operator < (const SimpleDB_tw_feedback_result & ) const;
...
class SimpleDB_tw_feedback_presult {
 public:


  virtual ~SimpleDB_tw_feedback_presult() throw();
...
class SimpleDBClient : virtual public SimpleDBIf {
 ...
 public:
  ...
  void tw_feedback(const std::string& msg);
  void send_tw_feedback(const std::string& msg);
  void recv_tw_feedback();
 protected:
...
class SimpleDBMultiface : virtual public SimpleDBIf {
 ...
 public:
  ...
  bool get_response(const std::string& msg) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->get_response(msg);
    }
    return ifaces_[i]->get_response(msg);
  }
...
class SimpleDBConcurrentClient : virtual public SimpleDBIf {
 ...
 public:
  ...
  void tw_feedback(const std::string& msg);
  int32_t send_tw_feedback(const std::string& msg);
  void recv_tw_feedback(const int32_t seqid);
 protected:
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> piprot_;
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> poprot_;
  ::apache::thrift::protocol::TProtocol* iprot_;
